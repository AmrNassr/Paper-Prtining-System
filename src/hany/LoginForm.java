...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/printer-icon-loop-dribbble-davegamez.gif"))); // NOI18N
...
if(monthh ==7 || monthh == 8)
{
    

        String name = txtname.getText();
        String pass = txtpassword.getText();
        String q = "SELECT * FROM battry.users where username=? and password=?";
        try {
