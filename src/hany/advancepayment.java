...
public final class advancepayment extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel10.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 340, 920, 340));
        ...
        jPanel10.add(delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 270, 180, 50));
   ...
   // else
        ...
        if (y > x) {
            try {
                String sql = "SELECT MIN(remaining) as remaining FROM battry.advanceamount where serial='" + serial + "' AND date between '" + curr + "' AND '" + end + "'";
                ...
                if (rs.next()) {
                    if (rs.getString("remaining") != null && rs.getString("remaining").trim().length() > 0) {
                        ...
                        String sql111 = "INSERT INTO battry.advanceamount (name,serial,amount,remaining,date) VALUES "
                        ...
                        String sqll = "SELECT salary FROM battry.employee where serial='" + serial + "'";
                        ...
                        if (rs.next()) {
                            ...
                            String sql1 = "INSERT INTO battry.advanceamount (name,serial,amount,remaining,date) VALUES "
    ...
    public void tablelord() {
        try {
            String sqll = "SELECT serial,name,amount,remaining,date FROM battry.advanceamount  ORDER BY serial ASC,\n"
                    + "    remaining DESC;";
            pst = (PreparedStatement) DBConnect.con.prepareStatement(sqll);
            rs = pst.executeQuery();
    ...
    public void comboxfromcombo() {
        ...
        cmserial.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent event) {
                ...
                try {
                    String sql = "SELECT name  FROM battry.employee where serial='" + cmserial.getSelectedItem().toString() + "'";
                    pst = (PreparedStatement) DBConnect.con.prepareStatement(sql);
                    rs = pst.executeQuery();
                    if (rs.next()) {
                ...
                try {
                    String sql = "SELECT MIN(remaining)as remaining  FROM battry.advanceamount where serial='" + cmserial.getSelectedItem().toString() + "' and date between '" + curr + "' AND '" + end + "'";
                    pst = (PreparedStatement) DBConnect.con.prepareStatement(sql);
                    rs = pst.executeQuery();
                    if (rs.next()) {
                        if (rs.getString("remaining") != null && rs.getString("remaining").trim().length() > 0) {
                            ...
                            String sql9 = "SELECT salary  FROM battry.employee where serial='" + cmserial.getSelectedItem().toString() + "'";
    ...
    public void serial() {
        try {
            String sql = "SELECT serial  FROM battry.employee order by CONVERT(replace(serial,'EM',''),UNSIGNED INTEGER) ASC ";
            pst = (PreparedStatement) DBConnect.con.prepareStatement(sql);
            rs = pst.executeQuery();
            while (rs.next()) {
    ...
    public void name() {
        try {
            String sql = "SELECT name  FROM battry.employee ";
            pst = (PreparedStatement) DBConnect.con.prepareStatement(sql);
            rs = pst.executeQuery();
            while (rs.next()) {
