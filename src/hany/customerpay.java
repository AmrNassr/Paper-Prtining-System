...
public class customerpay extends javax.swing.JFrame {
        ...
        try {
            ...
            if (totall < totall1) {
                ...
                if (dialogResult == 0) {
                    ...
                    try {
                        String sqla = "UPDATE battry.customeramount SET total = total-" + totall + " WHERE  name='" + cmname.getSelectedItem().toString() + "'";
  ...
  public void suppliers() {
        try {
            String sql = "SELECT distinct name  FROM battry.customeramount order by name ";
    ...
    public void comboxfromcombo1() {
        cmname.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent event) {
                ...
                try {
                    String sql = "SELECT total from battry.customeramount where name='" + cmname.getSelectedItem().toString() + "'";
                    pst = (PreparedStatement) DBConnect.con.prepareStatement(sql);
                    rs = pst.executeQuery();
                    while (rs.next()) {
