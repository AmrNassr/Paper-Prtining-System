...
public class paysupplier extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel14.setText("المورد");
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 70, 90, -1));
        ...
        try {
            ...
            if (totall < totall1) {
                ...
                if (dialogResult == 0) {
                    ...
                    try {
                        String sqla = "UPDATE battry.storesupplieramount SET total = total-" + totall + " WHERE  supplier='" + cmname.getSelectedItem().toString() + "'";
  ...
  public void suppliers() {
        try {
            String sql = "SELECT distinct supplier  FROM battry.storesupplieramount order by supplier ";
    ...
    public void comboxfromcombo1() {
        cmname.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent event) {
                ...
                try {
                    String sql = "SELECT total from battry.storesupplieramount where supplier='" + cmname.getSelectedItem().toString() + "'";
                    pst = (PreparedStatement) DBConnect.con.prepareStatement(sql);
                    rs = pst.executeQuery();
                    while (rs.next()) {
