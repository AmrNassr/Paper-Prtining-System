    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        if(serialid.getText().trim().isEmpty())
        {
            ...
            else
            {
                ...
                if(dialogResult == 0) {
                    try{
                        String sql = "INSERT INTO hany.employee (name,phone,type, salary,serial) VALUES"
            ...
            int dialogButton = JOptionPane.YES_NO_OPTION;
                ...
                if(dialogResult == 0) {
                 try {
                    ...
                    String sql = "UPDATE hany.employee SET type='"+typee+"',salary='"+salaryy+"', name='"+namee+"',  phone='"+phonee+"'  WHERE serial='"+serialid.getText()+"'";
                    pst=(PreparedStatement) DBConnect.con.prepareStatement(sql);
                    pst.executeUpdate();
...
JOptionPane.showMessageDialog(this, ex);
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        if(serialid.getText().trim().isEmpty())
        {
            ...
            if(dialogResult == 0) {
                try {
                    String sql = "DELETE FROM hany.employee WHERE serial='"+serialid.getText()+"'";
                    pst=(PreparedStatement) DBConnect.con.prepareStatement(sql);
                    pst.execute();
   ...
   public void tablelord()
    {
        try {
            String sqll = "SELECT serial,name,type,phone,salary FROM hany.employee";
 ...
 serialid.setText("");
       ...
       public void auto_id(){
         ...
         try {
             String sql = "SELECT serial FROM hany.employee ORDER BY serial DESC LIMIT 1";
             pst=(PreparedStatement) DBConnect.con.prepareStatement(sql);
             rs=pst.executeQuery();
             if(rs.next()){
