 ...
 * @author amnassar
 */
public final class searchsellbill extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "المجموع", "العدد", "السعر", "اسم المنتج", "ID"
            }
        ));
        ...
        jPanel14.add(itemname, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 260, 240, 40));
    ...
    private void cmcodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmcodeActionPerformed
        ...
        if (obj == cmcode) {
            try {
                String sqll = "SELECT *  FROM battry.storebillitems where  serial='" + cmcode.getSelectedItem().toString() + "'";
                ...
                while (rs.next()) {
                    ...
                    namee.setText(rs.getString("supplier"));

                }
                tablelord();
            } catch (SQLException ex) {
                Logger.getLogger(searchsellbill.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        itemname.setText(tmodel.getValueAt(selectrowindex, 3).toString());
        ...
        if (serialid.getText().trim().isEmpty()) {
            ...
            if (dialogResult == 0) {
                try {
                    ...
                    pst.execute();
                    String sqla1 = "UPDATE battry.storeitemlist SET number =number+" + number3.getText() + "   where barcode='" + itemname.getText() + "'";
                    pst = (PreparedStatement) DBConnect.con.prepareStatement(sqla1);
                    pst.executeUpdate();
                    tablelord();
                    double totalx = 0;
                    String sqll = "SELECT total  FROM eslam.sellbattryitems where  buyserial='" + cmcode.getSelectedItem().toString() + "'";
                    ...
                    String sqla1e = "UPDATE eslam.sellbattry SET total ='" + totalx + "'   where buyserial='" + cmcode.getSelectedItem().toString() + "'";
    ...
    private void add4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add4ActionPerformed
        ...
        try {
            double numbber = Double.parseDouble(number3.getText());
            double pricee = Double.parseDouble(price3.getText());
            double total = numbber * pricee;
            ...
            try {
                ...
                if (secondnumber > firstnumber) {
                    ...
                    String sqla1d = "UPDATE eslam.storeitemlist SET number =number-(" + totall + ")   where barcode='" + itemname.getText() + "'";
                ...
                String sqla1 = "UPDATE eslam.sellbattryitems SET number ='" + secondnumber + "',total='" + total + "'  WHERE  id='" + serialid.getText() + "' and buyserial='" + seriall + "'";
                pst = (PreparedStatement) DBConnect.con.prepareStatement(sqla1);
                pst.executeUpdate();
                tablelord();
                double totalx = 0;
    ...
    public void tablelord() {
        try {
            String sqll = "SELECT * FROM battry.storebillitems where serial='" + cmcode.getSelectedItem().toString() + "' order by id";
            pst = (PreparedStatement) DBConnect.con.prepareStatement(sqll);
            rs = pst.executeQuery();
    ...
    public void serials() {
        try {
            String sql = "SELECT serial  FROM battry.bill  order by buyserial";
            pst = (PreparedStatement) DBConnect.con.prepareStatement(sql);
            rs = pst.executeQuery();
            while (rs.next()) {
