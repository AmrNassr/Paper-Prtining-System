 ...
 * @author amnassar
 */
public class customerpayed extends javax.swing.JFrame {
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        try {
            ...
            in = this.getClass().getResourceAsStream("/reports/customerpayedbysupplier.jasper");
    ...
    public void msroffat() {
        try {
            String sql = "SELECT name  FROM battry.customer ";
