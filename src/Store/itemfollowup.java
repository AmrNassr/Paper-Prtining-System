 ...
 * @author amnassar
 */
public class itemfollowup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(code, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 20, 180, 30));
...
String codee = null;
        try {                                     
            ...
            String typee = code.getText();
            String sqll = "SELECT *  FROM battry.storeitemlist where  barcode='"+typee+"'";
            ...
            while (rs.next()) {
                codee=rs.getString("name");
            }
            InputStream in = null;
            try {
                
                in = this.getClass().getResourceAsStream("/reports/itemfollowup.jasper");
            ...
            Logger.getLogger(itemfollowup.class.getName()).log(Level.SEVERE, null, ex);
        }
